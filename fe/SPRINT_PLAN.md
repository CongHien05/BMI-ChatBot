...
### Backend Tasks
- [ ] Entities/repositories: ChatbotRule (Many-to-One Admin, priority, intent), AuditLog
- [ ] Admin portal (Thymeleaf + Spring MVC):
...
- [ ] API: `POST /api/chatbot` (ChatRequest/Response), optional `/api/chat/history`
- [ ] Integration/E2E tests cho chatbot flow + admin portal
- [ ] Docs: chatbot training manual, admin portal user guide, Gemini key setup
